...
foreach ($file in 'Defs', 'Assets.Gfx', 'Assets.Sfx', 'Voices', 'Map', 'Doors', 'Mechanics', 'Actors', 'Player', 'Render', 'Music', 'Mods', 'SaveGame', 'Transcript', 'Achievements', 'Demo', 'Dungeon', 'Settings', 'Network', 'Abilities', 'Story', 'Console', 'Terminal', 'Game', 'SelfTest') {
