...
function Save-Level([int]$Number, [string]$Name, [int]$Par, [string]$Ceiling, [string]$Floor, [string]$Rock, [string]$FilePrefix = 'level') {
...
Save-Level 2 'The Treasury' 120 '3A2A10' '6A5A30' 'WW' 'bonus'
