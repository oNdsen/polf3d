...
Add-Room 3 18 40 4 'SS' @(                                   # main corridor
    ...
    22, 0, 'o<',  12, 3, 'e>',  6, 0, '*l',    16, 3, '*l',   26, 0, '*l',  36, 3, '*l',   0, 0, '*f',  0, 3, '*f')
...
Add-Room 3 9 9 8 'WW' @(                                     # dorm A - some of them are asleep
    ...
    2, 1, 'gn',  6, 3, 'gw',  3, 5, 'g>',  6, 6, 'gs',  4, 0, '+f',  8, 7, '+a',  0, 7, '+1')
...
# =====================================================================================================
New-Grid 50 43
Add-Room 2 38 5 4 'GG' @(2, 2, 'P^',  0, 0, '*s',  4, 3, '+a')                       # arrival cave
...
Add-Room 35 20 10 12 'GG' @(                                 # flooded hall
    ...
    7, 5, 'e<',  8, 6, 'e<',  4, 1, 'ev',  5, 10, 'e^',  9, 2, 'g<',  9, 9, 'g<',  0, 0, '+a',  9, 11, '+h',  0, 11, '+a',  3, 4, 'mw',  3, 7, 'mw')
...
Add-Room 19 34 8 8 'GG' @(5, 2, 'd<',  6, 5, 'd<',  3, 3, 'g<',  7, 0, '+a',  7, 7, '+a',  0, 0, '+f',  4, 1, '*g')
...
Add-Room 45 10 6 10 'RR' @(                                  # storage
    ...
    3, 3, 'e<',  4, 7, 'g<',  5, 0, 'gw',  0, 0, '+a',  1, 9, '+a',  4, 9, '+a',  5, 5, '+m',  0, 5, '+h')
...
Add-Room 37 18 8 10 'RR' @(                                  # east tower: two commanders, one gold key each
    5, 2, 'b<',  5, 7, 'b<',  2, 4, 'e<',  7, 0, '*x',  7, 9, '*x',  0, 0, '*x',  0, 9, '+a',  7, 5, '+h',  7, 4, '+z')
Add-Room 14 3 20 12 'MM' @(                                  # throne hall
    10, 1, 'uv',  3, 3, 'ev',  16, 3, 'ev',  0, 0, 'ms',  19, 0, 'ms',  6, 2, 'ov',  13, 2, 'ov'
    4, 5, '*c',  15, 5, '*c',  4, 9, '*c',  15, 9, '*c',  9, 7, '*c',  10, 7, '*c'
    0, 11, '+h',  19, 11, '+h',  1, 11, '+a',  18, 11, '+a',  8, 11, '+z',  10, 11, '+q')
