...
$script:Palette = @(
    ...
    @('y^', 'Enemy: bug', 'enemy'), @('n^', 'Enemy: engineer', 'enemy'), @('a^', 'Enemy: auditor', 'enemy'),
    ...
    @('+v', 'Item: taser', 'tile'), @('+i', 'Item: two mines', 'tile'), @('+b', 'Item: armoured vest', 'tile'), @('+k', 'Item: keycard', 'tile'),
    ...
    @('*f', 'Deco: flag', 'tile'), @('*v', 'Deco: vat', 'tile'), @('*B', 'Deco: bed', 'tile'), @('*m', 'Deco: console', 'tile'), @('*r', 'Deco: server rack', 'tile'), @('*T', 'Deco: desk with terminal', 'tile'), @('*g', 'Deco: stalagmite', 'tile'),
